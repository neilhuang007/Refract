...
public class ColorVariable extends Variable<LightColor> implements LightColor {
   ...
   @Override
   public int red() { return this.actual().red(); }

   @Override
   public int blue() { return this.actual().blue(); }

   @Override
   public int green() { return this.actual().green(); }

   @Override
   public int toOpaque() { return this.actual().toOpaque(); }

   @Override
   public String toHex() { return this.actual().toHex(); }
}
