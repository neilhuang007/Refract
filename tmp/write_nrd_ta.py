...
out_path = r"E:\RE\photonics\assets\photonic\shaders\lighttree\nrd_temporal_accumulation.fsh"
with open(out_path, 'w', newline='\n', encoding='utf-8') as f:
    f.write(shader.lstrip())
print(f"Written {len(shader)} bytes to {out_path}")
