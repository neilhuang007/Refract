...
/* RENDERTARGETS:0,3,10,11,13 */
    ...
    gl_FragData[3] = vec4(0.5 * geoNormal + 0.5, 1.0);
...
/* RENDERTARGETS:0,3,6,10,11,13 */
        ...
        gl_FragData[4] = vec4(0.5 * geoNormal + 0.5, 1.0);
...
/* RENDERTARGETS:0,3,6,4,8,9,10,11,13 */
                ...
                gl_FragData[7] = vec4(0.5 * geoNormal + 0.5, 1.0);
...
/* RENDERTARGETS:0,3,6,4,8,10,11,13 */
                ...
                gl_FragData[6] = vec4(0.5 * geoNormal + 0.5, 1.0);
...
/* RENDERTARGETS:0,3,6,9,10,11,13 */
            ...
            gl_FragData[5] = vec4(0.5 * geoNormal + 0.5, 1.0);
