...
uniform sampler2D radiosity_temporal_reservoirs;
uniform sampler2D radiosity_temporal_reservoir_samples;
uniform sampler2D radiosity_temporal_reservoir_meta;
...
uniform sampler2D radiosity_indirect_temporal_position;
uniform sampler2D radiosity_indirect_temporal_normal;
